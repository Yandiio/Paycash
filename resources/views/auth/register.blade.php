                    ...
                    <form method="POST" action="{{ route('register') }}">
                       {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" placeholder="Nama Pengguna" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" placeholder="Ulangi Kata Sandib" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="jenkel" class="form-control @error('jenkel') is-invalid @enderror" name="jenkel" value="{{ old('jenkel') }}" required autocomplete="jenkel">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tempat_lahir" type="text" placeholder="Kota Lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required autocomplete="tempat_lahir" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="text" placeholder="Alamat Tinggal" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat') }}" required autocomplete="alamat" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="status_pegawai" class="col-md-4 col-form-label text-md-right">{{ __('Status Pegawai') }}</label>
                        
                            <div class="col-md-6">
                                <select name="status_pegawai" class="form-control @error('status_pegawai') is-invalid @enderror" name="status_pegawai" value="{{ old('status_pegawai') }}" required autocomplete="status_pegawai">
