...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pembayaran DSP</li>
                </ol>
            </nav>
        </div>
        <div class="col-120 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title"><b>Pembayaran DSP</b></h2>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" aria-label="Masukan nama">
                    </div>
                    <div class="form-group">
